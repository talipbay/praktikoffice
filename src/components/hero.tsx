  ...
  return (
    <div className="flex flex-col mx-auto justify-center items-center relative z-30 bg-black transition-colors duration-300">
      <div className="container mx-auto min-h-[calc(100vh-100px)] flex flex-col items-center justify-center">
        <h1 
          className="leading-tight text-4xl font-manrope md:text-6xl font-medium text-center text-foreground transition-colors duration-300"
          data-cursor="huge"
        >
          {t('title')} 
          <br></br>{" "}
          ...
          <br></br>{" "}
          <span className="italic font-light font-melodrama text-7xl md:text-9xl">
            {t('subtitle')}
          </span>
        </h1>
      </div>
